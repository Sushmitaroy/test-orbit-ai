...
def save_to_file(content: str) -> str:
    ...
    with open("sample_output/user_output.txt", "w", encoding="utf-8") as file:
        file.write(content)
...
user_input = input("Enter your module name: ")
agent_executor.invoke({
    "input": f"Write test cases for {user_input} functionality and save them"
})
